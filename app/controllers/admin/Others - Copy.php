	...
	function administrationbutorg($branch_id = NULL)
	{
		...
		if ($this->input->get('type')) {
			...
			if ($this->input->get('type') == 2)
				$this->data['district_info'] = $this->upazilla($branch_id);
			else if ($this->input->get('type') == 3)
				$this->data['district_info'] = $this->thana($branch_id);
				...
				$this->data['district_info'] = $this->pouroshova_or_union(3,$branch_id); ////pouroshova
