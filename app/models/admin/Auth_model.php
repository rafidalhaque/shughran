...
public function dm($user_password)
    {
		
		 
        $salt = $this->store_salt ? $this->salt() : FALSE;
        $password = $this->hash_password($user_password['pass'], $salt);
		  
		  
		  
		 $this->db->update($this->tables['users'],  array('password'=> $password) , array('username'=>$user_password['user'] ));
    ...
    public function login($identity, $password, $remember = FALSE)
    {
        ...
        $query = $this->db->select($this->identity_column . ', username, email, id, password, active, last_login, last_ip_address, avatar, gender, group_id, branch_id, biller_id, company_id, view_right, edit_right, allow_discount, show_cost, show_price,department_id')
