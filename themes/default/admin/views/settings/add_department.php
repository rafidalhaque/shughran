    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <?php
                $dep[''] = lang('select').' '.lang('parent_department');
                if($departments) foreach ($departments as $pdep) {
                    $dep[$pdep->id] = $pdep->name;
                }
                echo form_dropdown('parent', $dep, (isset($_POST['parent']) ? $_POST['parent'] : ''), 'class="form-control select" id="parent" style="width:100%"')
                ?>
            </div>

        </div>
        <div class="modal-footer">
            <?php echo form_submit('add_department', lang('add_department'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
