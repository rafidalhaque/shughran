...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#CURData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('system_settings/getBranches') ?>',
...
<?= admin_form_open('system_settings/branch_actions', 'id="action-form"') ?>
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
			...
			<li class="dropdown">
                            <a href="<?php echo admin_url('system_settings/add_branch'); ?>" data-toggle="modal" data-target="#myModal">
                                <i class="icon fa fa-plus"></i> <?= lang('add_branch') ?>
                            </a>
                            </li>
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <li>
                            <a href="#" id="delete" data-action="delete">
                                <i class="fa fa-trash-o"></i> <?= lang('delete_branches') ?>
                            </a>
                        </li>
