        ...
        <table class="lt"><tr><td class="sidebar-con">
            <div id="sidebar-left">
                <div class="sidebar-nav nav-collapse collapse navbar-collapse" id="sidebar_menu">
				  ...
				  <li id="" class="<?php  echo ($this->uri->segment(2)=='others' &&  ($this->uri->segment(3) == 'program' ) )? 'active':'' ?>">
                                            <a href="<?= admin_url('others/program') ?>">
                                                <i class="fa fa-cogs"></i><span class="text"> <?= "সভাসমূহ "; ?></span>
                                            </a>
                             </li>
