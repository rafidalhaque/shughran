            ...
            <div id="sidebar-left">
                <div class="sidebar-nav nav-collapse collapse navbar-collapse" id="sidebar_menu">
                    <ul class="nav main-menu">
                        ...
                        <li class="mm_schoolkarjokrom" class="<?php echo ($this->uri->segment(3)=='school-karjokrom-bivag')?'active':'' ?>">
                            <a href="<?= admin_url('departmentsreport/school-karjokrom-bivag') ?>">
                                <i class="fa fa-dashboard"></i>
                                <span class="text"> স্কুল কার্যক্রম বিভাগ</span>
                            </a>
                        </li>
