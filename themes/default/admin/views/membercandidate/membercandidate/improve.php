...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= 'Member Candidate Improve'; ?></h2>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="col-md-5">
                   ...
                   <div class="form-group">
                        <?php echo lang('সদস্যপ্রার্থী হওয়ার তারিখ', 'date'); ?>
                        <div class="controls">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <?php echo form_submit('add_manpower', 'Save', 'class="btn btn-primary form_saving"'); ?>
                         <p id="saving" class="hidden">Saving....</p>
					</div>
  ...
  $('#manpower_id').select2({
            ...
            initSelection: function (element, callback) {
                $.ajax({
                    ...
                    url: "<?=admin_url('membercandidate/getName/')?>"+$(element).val(),
                    dataType: "json",
            ...
            ajax: {
                url: site.base_url + "membercandidate/suggestions",
                dataType: 'json',
                quietMillis: 15,
