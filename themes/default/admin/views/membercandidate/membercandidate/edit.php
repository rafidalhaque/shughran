    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("membercandidate/edit/" . $manpower->id, $attrib)
                ?>
                <div class="col-md-5">
                ...
                <div class="col-md-6 col-md-offset-1">
                    ...
                    <div class="form-group">
                        <?php echo lang('Improvement date', 'date'); ?>
                        <div class="controls">
                            <?php echo form_input('date', $manpower->membercandidate_oath_date ? $this->sma->hrsd($manpower->membercandidate_oath_date) : '' , 'class="form-control date2" id="date" required="required" readonly="readonly"'); ?>
                        </div>
                    </div>
