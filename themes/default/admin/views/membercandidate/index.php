 ...
 echo $membercandidate_target;
  ...
  echo $membercandidate_improvement_d;
   ...
   <td class="tg-y698">সাথী </td>
	...
	<?php
	$membercandidate_prev =  $prev_manpower[0]['membercandidate'];
	echo $membercandidate_prev;
	?>
	 </td>
  ...
  <?php  $membercandidate_candidate_prev =  $prev_manpower[0]['membercandidate_candidate'];
	...
	$membercandidate_candidate_study_abroad = sum_manpower($manpower_record,  'membercandidate_candidate_abroad_study');
	$membercandidate_candidate_job_abroad = sum_manpower($manpower_record,   'membercandidate_candidate_abroad_job');
	...
	$total_membercandidate_candidate_decrease = $membercandidate_candidate_improvement_d + $membercandidate_candidate_endstd  + $membercandidate_candidate_transfer  + $membercandidate_candidate_cancel  + $membercandidate_candidate_study_abroad + $membercandidate_candidate_job_abroad + $membercandidate_candidate_death + $membercandidate_candidate_martyr + $membercandidate_candidate_demotion;
	
	$membercandidate_candidate_improvement_target = sum_manpower($manpower_record,'membercandidate_candidate_improvement_target');
	
	$membercandidate_candidate_postpone = sum_manpower($manpower_record,   'membercandidate_candidate_postpone');
  ...
  echo $membercandidate_candidate_improvement + $membercandidate_candidate_arrival;
    ...
    <td class="tg-0pky ">
	<?php 
  echo $membercandidate_candidate_improvement;
	?>
	</td>
    <td class="tg-0pky ">
	<?php 
	
	echo $membercandidate_candidate_arrival;
	?>
	</td>
    <td class="tg-0pky ">
	<?php   
	echo $membercandidate_candidate_improvement_target;
	?>
	</td>
    <td class="tg-0pky ">
	<?php   
    ...
    <td class="tg-0pky "><?php  echo $total_membercandidate_candidate_decrease; ?></td>
    <td class="tg-0pky ">
	<?php 
  echo $membercandidate_candidate_improvement_d;
    ...
    <td class="tg-0pky "><?php  echo $membercandidate_candidate_endstd; ?></td>
    <td class="tg-0pky ">
	<?php echo $membercandidate_candidate_transfer; ?>
	</td>
    <td class="tg-0pky">
	<?php  echo $membercandidate_candidate_cancel; ?>
	</td>
    <td class="tg-0pky ">
	<?php  echo $membercandidate_candidate_study_abroad; ?>
	</td>
    <td class="tg-0pky ">
	<?php  echo $membercandidate_candidate_job_abroad; 	?>
	
	</td>
    <td class="tg-0pky ">
	<?php  echo $membercandidate_candidate_death; 	?>
	</td>
    <td class="tg-0pky">
	<?php  echo $membercandidate_candidate_martyr; ?>
	</td>
    <td class="tg-0pky">
	<?php  echo $membercandidate_candidate_demotion; ?>
	</td>
    <td class="tg-0pky">
	<?php echo $membercandidate_candidate_postpone; ?>
  ...
  echo $worker_improvement;
    ...
    <td class="tg-0pky  type_7">
	<?php   
	echo  ($worker_improvement_target>0) ? round(100*$worker_improvement/$worker_improvement_target,2) : 0;;
	?>
