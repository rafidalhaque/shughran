...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-barcode"></i><?= lang('manpower') . ' (' . ($branch_id ? $branch->name : 'সকল শাখা') . ')'; ?>
        </h2>
...
<table class="tg table table-header-rotated" id="testTable2">
  <tr>
    ...
    <td class="tg-pwj7 rotate" rowspan="3"><div><span>বর্তমান সংখ্যা</span></div>
 </td>
  ...
  <tr>
    ...
    <td class="tg-y698 rotate"><div><span>বাতিল  </span></div></td>
  </tr>
  <tr>
...
<a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="manpower_record" data-pk="<?php echo $pk;?>" data-url="<?php echo admin_url('manpower/detailupdate');?>" data-name="member_candidate_candidate_target" data-title="Enter"><?php echo $membercandidate_target;?></a> 
  ...
  echo $membercandidate_improvement_d;
   ...
   <td class="tg-y698">সাথী </td>
	...
	<?php  $membercandidate_prev =  $prev_manpower[0]['membercandidate'];
	echo $membercandidate_prev;
	?>
	 </td>
	
	<?php 
	$membercandidate_improvement = (!$assolog) ? 0 : calculate($assolog, 2,1, 'membercandidate_number');
	$membercandidate_arrival =(!$assolog) ? 0 : calculate($assolog, 15,1, 'membercandidate_number');
	
	$membercandidate_endstd = (!$assolog) ? 0 : calculate($assolog, 8,2, 'membercandidate_number');
	$membercandidate_transfer = (!$assolog) ? 0 : calculate($assolog, 15,2, 'membercandidate_number');
	$membercandidate_cancel = (!$assolog) ? 0 : calculate($assolog, 12,2, 'membercandidate_number');
	$membercandidate_study_abroad =  (!$assolog) ? 0 : calculate($assolog, 11,2, 'membercandidate_number');
	$membercandidate_job_abroad = (!$assolog) ? 0 :  calculate($assolog, 14,2, 'membercandidate_number');
	$membercandidate_death = (!$assolog) ? 0 : calculate($assolog, 9,2, 'membercandidate_number');
	$membercandidate_martyr = (!$assolog) ? 0 : calculate($assolog, 10,2, 'membercandidate_number');
	$membercandidate_demotion = (!$assolog) ? 0 : calculate($assolog, 13,2, 'membercandidate_number');
	$membercandidate_improvement_d = $member_improvement;
  ...
  echo $membercandidate_improvement;
	...
	<?php   
	echo $membercandidate_prev + $member_prev;
	?>
	</td>
    <td class="tg-y698  type_7">
	<?php   
	echo  ($membercandidate_prev + $member_prev>0) ? round(100*$membercandidate_improvement/($membercandidate_prev + $member_prev),2) : 0;;
	?>
    ...
    <td class="tg-y698  type_8"><?php  echo $total_membercandidate_decrease; ?></td>
  ...
  echo $membercandidate_improvement_d;
    ...
    <td class="tg-y698  type_10"><?php  echo $membercandidate_endstd; ?></td>
  ...
  <?php  $membercandidate_candidate_prev =  $prev_manpower[0]['membercandidate_candidate'];
	
	  
	$membercandidate_candidate_improvement = sum_manpower($manpower_record,'membercandidate_candidate_improvement');
	$membercandidate_candidate_arrival = sum_manpower($manpower_record,   'membercandidate_candidate_arrival');
	
	$membercandidate_candidate_endstd = sum_manpower($manpower_record,   'membercandidate_candidate_endstd');
	$membercandidate_candidate_transfer = sum_manpower($manpower_record,   'membercandidate_candidate_transfer');
	$membercandidate_candidate_cancel = sum_manpower($manpower_record,   'membercandidate_candidate_cancel');
	$membercandidate_candidate_abroad_study = sum_manpower($manpower_record,  'membercandidate_candidate_abroad_study');
	$membercandidate_candidate_abroad_job = sum_manpower($manpower_record,   'membercandidate_candidate_abroad_job');
	$membercandidate_candidate_death = sum_manpower($manpower_record,  'membercandidate_candidate_death');
	$membercandidate_candidate_martyr = sum_manpower($manpower_record,   'membercandidate_candidate_martyr');
	$membercandidate_candidate_demotion = sum_manpower($manpower_record,   'membercandidate_candidate_demotion');
	$membercandidate_candidate_improvement_d = $membercandidate_improvement;
	$total_membercandidate_candidate_decrease = $membercandidate_candidate_improvement_d + $membercandidate_candidate_endstd  + $membercandidate_candidate_transfer  + $membercandidate_candidate_cancel  + $membercandidate_candidate_abroad_study + $membercandidate_candidate_abroad_job + $membercandidate_candidate_death + $membercandidate_candidate_martyr + $membercandidate_candidate_demotion;
	
	$membercandidate_candidate_improvement_target = sum_manpower($manpower_record,'membercandidate_candidate_improvement_target');
   ...
   <tr>
    ...
    <td class="tg-0pky"><?php echo $membercandidate_candidate_prev;?></td>
     <td class="tg-0pky  type_2">
	<?php 
  echo $membercandidate_candidate_prev + $membercandidate_candidate_improvement + $membercandidate_candidate_arrival - $total_membercandidate_candidate_decrease;
	?>
	</td>
    <td class="tg-0pky  type_3">
	<?php 
  echo $membercandidate_candidate_improvement + $membercandidate_candidate_arrival;
	?>
	</td>
    <td class="tg-0pky  type_4">
...
<?php 
	...
	if(isset($manpower_record[0])) {
	$membercandidate_candidate_improvement = $arr['membercandidate_candidate_improvement'];
 	$pk =  $arr['id'];
	}
	
	else {
		$membercandidate_candidate_improvement = 0;
		$pk =  "";
	}
  ?>	
 
<a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="manpower_record" data-pk="<?php echo $pk;?>" data-url="<?php echo admin_url('manpower/detailupdate');?>" data-name="membercandidate_candidate_improvement" data-title="Enter"><?php echo $membercandidate_candidate_improvement;?></a> 
...
<?php 
	...
	if(isset($manpower_record[0])) {
	$membercandidate_candidate_arrival = $arr['membercandidate_candidate_arrival'];
 	$pk =  $arr['id'];
	}
	
	else {
		$membercandidate_candidate_arrival = 0;
		$pk =  "";
	}
  ?>	
 
<a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="manpower_record" data-pk="<?php echo $pk;?>" data-url="<?php echo admin_url('manpower/detailupdate');?>" data-name="membercandidate_candidate_arrival" data-title="Enter"><?php echo $membercandidate_candidate_arrival;?></a> 
...
<?php 
	...
	if(isset($manpower_record[0])) {
	$membercandidate_candidate_improvement_target = $arr['membercandidate_candidate_improvement_target'];
 	$pk =  $arr['id'];
	}
	
	else {
		$membercandidate_candidate_improvement_target = 0;
		$pk =  "";
	}
  ?>	
 
<a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="manpower_record" data-pk="<?php echo $pk;?>" data-url="<?php echo admin_url('manpower/detailupdate');?>" data-name="membercandidate_candidate_improvement_target" data-title="Enter"><?php echo $membercandidate_candidate_improvement_target;?></a> 
    ...
    <td class="tg-0pky  type_7">
	<?php   
	echo  ($membercandidate_candidate_improvement_target>0) ? round(100*$membercandidate_candidate_improvement/$membercandidate_candidate_improvement_target,2) : 0;;
	?>
    ...
    <td class="tg-0pky  type_8"><?php  echo $total_membercandidate_candidate_decrease; ?></td>
    <td class="tg-0pky  type_9">
	<?php 
  echo $membercandidate_candidate_improvement_d;
	?>
...
<?php 
	...
	if(isset($manpower_record[0])) {
	$membercandidate_candidate_endstd = $arr['membercandidate_candidate_endstd'];
 	$pk =  $arr['id'];
	}
	
	else {
		$membercandidate_candidate_endstd = 0;
		$pk =  "";
	}
  ?>	
 
<a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="manpower_record" data-pk="<?php echo $pk;?>" data-url="<?php echo admin_url('manpower/detailupdate');?>" data-name="membercandidate_candidate_endstd" data-title="Enter"><?php echo $membercandidate_candidate_endstd;?></a> 
...
<?php 
	...
	if(isset($manpower_record[0])) {
	$membercandidate_candidate_transfer = $arr['membercandidate_candidate_transfer'];
 	$pk =  $arr['id'];
	}
	
	else {
		$membercandidate_candidate_transfer = 0;
		$pk =  "";
	}
  ?>	
 
<a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="manpower_record" data-pk="<?php echo $pk;?>" data-url="<?php echo admin_url('manpower/detailupdate');?>" data-name="membercandidate_candidate_transfer" data-title="Enter"><?php echo $membercandidate_candidate_transfer;?></a> 
...
<?php 
	...
	if(isset($manpower_record[0])) {
	$membercandidate_candidate_cancel = $arr['membercandidate_candidate_cancel'];
 	$pk =  $arr['id'];
	}
	
	else {
		$membercandidate_candidate_cancel = 0;
		$pk =  "";
	}
  ?>	
 
<a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="manpower_record" data-pk="<?php echo $pk;?>" data-url="<?php echo admin_url('manpower/detailupdate');?>" data-name="membercandidate_candidate_cancel" data-title="Enter"><?php echo $membercandidate_candidate_cancel;?></a> 
...
<?php 
	...
	if(isset($manpower_record[0])) {
	$membercandidate_candidate_abroad_study = $arr['membercandidate_candidate_abroad_study'];
 	$pk =  $arr['id'];
	}
	
	else {
		$membercandidate_candidate_abroad_study = 0;
		$pk =  "";
	}
  ?>	
 
<a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="manpower_record" data-pk="<?php echo $pk;?>" data-url="<?php echo admin_url('manpower/detailupdate');?>" data-name="membercandidate_candidate_abroad_study" data-title="Enter"><?php echo $membercandidate_candidate_abroad_study;?></a> 
...
<?php 
	...
	if(isset($manpower_record[0])) {
	$membercandidate_candidate_abroad_job = $arr['membercandidate_candidate_abroad_job'];
 	$pk =  $arr['id'];
	}
	
	else {
		$membercandidate_candidate_abroad_job = 0;
		$pk =  "";
	}
  ?>	
 
<a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="manpower_record" data-pk="<?php echo $pk;?>" data-url="<?php echo admin_url('manpower/detailupdate');?>" data-name="membercandidate_candidate_abroad_job" data-title="Enter"><?php echo $membercandidate_candidate_abroad_job;?></a> 
...
<?php 
	...
	if(isset($manpower_record[0])) {
	$membercandidate_candidate_death = $arr['membercandidate_candidate_death'];
 	$pk =  $arr['id'];
	}
	
	else {
		$membercandidate_candidate_death = 0;
		$pk =  "";
	}
  ?>	
 
<a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="manpower_record" data-pk="<?php echo $pk;?>" data-url="<?php echo admin_url('manpower/detailupdate');?>" data-name="membercandidate_candidate_death" data-title="Enter"><?php echo $membercandidate_candidate_death;?></a> 
...
<?php 
	...
	if(isset($manpower_record[0])) {
	$membercandidate_candidate_martyr = $arr['membercandidate_candidate_martyr'];
 	$pk =  $arr['id'];
	}
	
	else {
		$membercandidate_candidate_martyr = 0;
		$pk =  "";
	}
  ?>	
 
<a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="manpower_record" data-pk="<?php echo $pk;?>" data-url="<?php echo admin_url('manpower/detailupdate');?>" data-name="membercandidate_candidate_martyr" data-title="Enter"><?php echo $membercandidate_candidate_martyr;?></a> 
		
	
	 
	</td>
    <td class="tg-0pky  type_17">
	<?php  echo $membercandidate_candidate_demotion; ?>
	</td>
...
<?php 
	...
	if(isset($manpower_record[0])) {
	$membercandidate_candidate_postpone = $arr['membercandidate_candidate_postpone'];
 	$pk =  $arr['id'];
	}
	
	else {
		$membercandidate_candidate_postpone = 0;
		$pk =  "";
	}
  ?>	
 
<a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="manpower_record" data-pk="<?php echo $pk;?>" data-url="<?php echo admin_url('manpower/detailupdate');?>" data-name="membercandidate_candidate_postpone" data-title="Enter"><?php echo $membercandidate_candidate_postpone;?></a> 
  ...
  <?php  $worker_prev =  $prev_manpower[0]['worker'];
	...
	$worker_improvement_d = $membercandidate_improvement;
	...
	$worker_improvement_target = $worker_prev  + $member_prev  + $membercandidate_prev ;
...
<?php 
	...
	if(isset($manpower_record[0])) {
	$worker_study_abroad = $arr['worker_abroad_study'];
 	$pk =  $arr['id'];
	}
	
	else {
		$worker_study_abroad = 0;
		$pk =  "";
	}
  ?>	
 
<a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="manpower_record" data-pk="<?php echo $pk;?>" data-url="<?php echo admin_url('manpower/detailupdate');?>" data-name="worker_abroad_study" data-title="Enter"><?php echo $worker_study_abroad;?></a> 
...
<?php 
	...
	if(isset($manpower_record[0])) {
	$worker_job_abroad = $arr['worker_abroad_job'];
 	$pk =  $arr['id'];
	}
...
<a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="manpower_record" data-pk="<?php echo $pk;?>" data-url="<?php echo admin_url('manpower/detailupdate');?>" data-name="worker_abroad_job" data-title="Enter"><?php echo $worker_job_abroad;?></a> 
...
<a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="manpower_record" data-pk="<?php echo $pk;?>" data-url="<?php echo admin_url('manpower/detailupdate');?>" data-name="worker_death" data-title="Enter"><?php echo $worker_death;?></a> 
