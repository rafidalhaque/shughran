...
<script>
    ...
    $(document).ready(function () {
        oTable = $('#PRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('manpower/getDecreaseMember/'.$process->id.($branch_id ? '/'.$branch_id : '')) ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-barcode"></i><?= 'সদস্য ঘাটতি: '.$process->process . ' (' . ($branch_id ? $branch->name : 'সকল শাখা') . ')'; ?>
        </h2>

        <div class="box-icon">
            <ul class="btn-tasks">
               <li>	
                            <a href="<?= admin_url('manpower/memberdecreaseexport/'.$process->id.($branch_id ? '/'.$branch_id : '')) ?>" id="excel_export" data-action="export_excel">	
