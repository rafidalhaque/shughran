                    ...
                    <div class="tg-wrap">
                        <table class="tg table table-header-rotated" id="testTable2">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky type_1">
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="manobodhikar_bivag3" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate');?>" data-name="shn_s" data-title="Enter"><?php echo $shn_s=  (isset( $manobodhikar_bivag3['shn_s']))? $manobodhikar_bivag3['shn_s']:'' ?></a>
                                </td>
