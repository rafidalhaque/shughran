...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-barcode"></i><?= 'এক নজরে রিকুরমেন্' . ' (' . ($branch_id ? $branch->name : 'সকল শাখা') . ')'; ?>
        </h2>
	...
	border: 1px solid #ccc;
                    ...
                    <div class="tg-wrap">
                        <table class="tg table table-header-rotated" id="testTable2">
                            ...
                            <td class="tg-0pky"> 
							<?php echo $kg_a = $total_media_bivag7_aknojore_rikrutment['kg_a'] ?>
							</td>
                            <td class="tg-0pky">
                            <?php echo $kg_b = $total_media_bivag7_aknojore_rikrutment['kg_b'] ?>
                            </td>
                            <td class="tg-0pky">
                            <?php echo $kg_c = $total_media_bivag7_aknojore_rikrutment['kg_c'] ?>
                            </td>
                            <td class="tg-0pky">
                            <?php echo $ajtgm = $total_media_bivag7_aknojore_rikrutment['ajtgm'] ?>
                            </td>
                            <td class="tg-0pky">
                            <?php echo $jgmmfsgm_tv = $total_media_bivag7_aknojore_rikrutment['jgmmfsgm_tv'] ?>
                            </td>
                            <td class="tg-0pky">
                            <?php echo $jgmmfsgm_rfm = $total_media_bivag7_aknojore_rikrutment['jgmmfsgm_rfm'] ?>
                            </td>
                            <td class="tg-0pky">
                            <?php echo $jgmmfsgm_print = $total_media_bivag7_aknojore_rikrutment['jgmmfsgm_print'] ?>
                            </td>
                            <td class="tg-0pky">
                            <?php echo $jgmmfsgm_online = $total_media_bivag7_aknojore_rikrutment['jgmmfsgm_online'] ?>
                            </td>
