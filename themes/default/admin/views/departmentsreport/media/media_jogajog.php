                    ...
                    <div class="tg-wrap">
                        <table class="tg table table-header-rotated" id="testTable2">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky" >
                                <?php echo $sbdk_s = $total_media_bivag3['sbdk_s'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $sbdk_montb = $total_media_bivag3['sbdk_montb'] ?>
                                </td>
                                <td class="tg-y698" >বন্ধু </td>
                                <td class="tg-0pky" >
                                <?php echo $bondu_s = $total_media_bivag3['bondu_s'] ?>
                                </td>
                                <td class="tg-0pky" >
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky" >
                                <?php echo $chtro_s = $total_media_bivag3['chtro_s'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $chtro_montb = $total_media_bivag3['chtro_montb'] ?>
                                </td>
                                <td class="tg-y698" >শিক্ষক</td>
                                <td class="tg-0pky" >
                                <?php echo $shkhok_s = $total_media_bivag3['shkhok_s'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $shkhok_montb = $total_media_bivag3['shkhok_montb'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky" >
                                <?php echo $somdk_s = $total_media_bivag3['somdk_s'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $somdk_montb = $total_media_bivag3['somdk_montb'] ?>
                                </td>
                                <td class="tg-y698" > কলামিস্ট </td>
                                <td class="tg-0pky" >
                                <?php echo $cllmst_s = $total_media_bivag3['cllmst_s'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $cllmst_montb = $total_media_bivag3['cllmst_montb'] ?>
                                </td>
