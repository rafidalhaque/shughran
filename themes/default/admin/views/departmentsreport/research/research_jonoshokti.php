                    ...
                    <div class="tg-wrap">
                        <table class="tg table table-header-rotated" id="testTable2">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky"><?php echo $sodosso = $total_research_jonoshokti['sodosso'] ?> </td>
                                <td class="tg-pwj7">সাথী  </td>
                                <td class="tg-0pky"><?php echo $sathi = $total_research_jonoshokti['sathi'] ?> </td> </td>
                                <td class="tg-pwj7">কর্মী </td>
                                <td class="tg-0pky"><?php echo $kormi = $total_research_jonoshokti['kormi'] ?> </td> </td>
