...
<script>
    ...
    $(document).ready(function () {
        oTable = $('#PRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('departmentsreport/getLibraryIncreaseDecrease'.($branch_id ? '/'.$branch_id : '')) ?>',
            ...
            {column_number: 1, filter_default_label: "[<?='Thana_Name';?>]", filter_type: "text", data: []},
            {column_number: 2, filter_default_label: "[<?='Branch';?>]", filter_type: "text", data: []},
			{column_number: 3, filter_default_label: "[<?='Increase_Number';?>]", filter_type: "text", data: []},
			{column_number: 4, filter_default_label: "[<?='Decrease_Number';?>]", filter_type: "text", data: []}, 
			{column_number: 5, filter_default_label: "[<?='Book_Increase';?>]", filter_type: "text", data: []}, 
			{column_number: 6, filter_default_label: "[<?='Book_Decrease';?>]", filter_type: "text", data: []}, 
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-barcode"></i><?= 'এ সেশনে পাঠাগার বৃদ্ধি ও ঘাটতি' . ' (' . ($branch_id ? $branch->name : 'সকল শাখা') . ')'; ?>
        </h2>
            ...
            <ul class="btn-tasks">
			 ...
			 <?php if($branch_id) {?>
                <li>
						 ...
						 <a class="tip" title="Add" href="<?=  admin_url('departmentsreport/addlibraryincreasedecrease/'.$branch_id); ?>" data-toggle='modal' data-target='#myModal'><i class="icon fa fa-plus">যোগ করুন</i>  </a>			 
