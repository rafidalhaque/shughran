                        ...
                        <table class="tg table table-header-rotated" id="testTable2">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $total_bigganshikha_somporkito['bskabbnkkaj_s'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                    <?php echo $total_bigganshikha_somporkito['bskabbnkkaj_tkak'] ?>
                                </td>
                            </tr>

                            <tr>
                                <td class="tg-y698 type_1">বিজ্ঞান বিষয়ে বিভিন্ন ম্যাগাজিনে লেখালেখি করেন এমন জনশক্তি
                                </td>
                                <td class="tg-0pky  type_1">
                                    <?php echo $total_bigganshikha_somporkito['bbbvmlekaj_s'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                    <?php echo $total_bigganshikha_somporkito['bbbvmlekaj_tkak'] ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="tg-y698 type_1">এলাকাধীন বিজ্ঞানী বা বিজ্ঞানক্ষেত্রে জনপ্রিয় হয়েছেন এমন
                                        জনশক্তি</td>
                                <td class="tg-0pky  type_1">
                                    <?php echo $total_bigganshikha_somporkito['adhbbkhjb_s'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                    <?php echo $total_bigganshikha_somporkito['adhbbkhjb_tkak'] ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $total_bigganshikha_somporkito['sjabbptppaakj_s'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                    <?php echo $total_bigganshikha_somporkito['sjabbptppaakj_tkak'] ?>
                                </td>
                            </tr>
                            <tr>
