...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                ...
                class="fa-fw fa fa-barcode"></i><?= 'একাডেমিক সহযোগীতা' . ' (' . ($branch_id ? $branch->name : 'সকল শাখা') . ')'; ?>
                        ...
                        <table class="tg table table-header-rotated" id="testTable2">
                            <tr>
                                ...
                                <td class="tg-0pky  type_1" colspan="">
                                    <?php echo $total_academik_sohojogita['bnbgshdjadkakhana'] ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="tg-pwj7 type_1" colspan="">২। কোচিং থাকলে সেখানে আইসিটি সাবজেক্ট পড়ানো হয়
                                    কিনা</td>
                                <td class="tg-0pky type_1" colspan="">
                                    <?php echo $total_academik_sohojogita['kthsasphk'] ?>
                                </td>
                                <td class="tg-pwj7 type_1" colspan="">কোচিং-এ আইসিটি কোর্সের মোট শিক্ষার্থী</td>
                                <td class="tg-0pky type_1" colspan="">
                                    <?php echo $total_academik_sohojogita['ucmpbchdjahs'] ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky type_1" colspan="">
                                    <?php echo $total_academik_sohojogita['kaakmsh'] ?>
                                </td>
                                <td class="tg-pwj7 type_1" colspan="">আইডিয়াল হোমের ছাত্রসংখ্যা</td>
                                <td class="tg-0pky type_1" colspan="">
                                    <?php echo $total_academik_sohojogita['ahchs'] ?>
                                </td>
                            </tr>
