...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                ...
                class="fa-fw fa fa-barcode"></i><?= 'উচ্চশীক্ষা সম্পর্কিত' . ' (' . ($branch_id ? $branch->name : 'সকল শাখা') . ')'; ?>
                        ...
                        <table class="tg table table-header-rotated" id="testTable2">
                            ...
                            <tr>
                                <td class="tg-0pky  type_1" colspan="">
                                    <?php echo $total_uccoshikkha_somporkito['abushbgkjs'] ?>
                                </td>
                                <td class="tg-0pky  type_1" colspan="">
                                    <?php echo $total_uccoshikkha_somporkito['ushbjpnajs'] ?>
                                </td>
                            </tr>
