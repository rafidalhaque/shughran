...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo 'বিদেশে অধ্যয়নরত জনশক্তদিরে তালকিা' .  ': Entry'; ?></h4>
        </div>
        
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form', 'id'=>'add_institute');
        echo admin_form_open_multipart("departmentsreport/addhighereducationmanpower/" .$branch_id, $attrib); ?>
			...
			<div class="row">
				 ...
				 <div class="col-md-6 col-sm-6">
                     ...
                     <div class="form-group">
									...
									<label for="education">অর্নাস/ মার্স্টাস/পএিইচডি</label>
                    <?php echo form_input('education', '', 'class="form-control"  id="education"'); ?>                  
                </div>
...
<div class="col-md-12">
        ...
        <div class="modal-footer">
            <?php echo form_submit('highereducationmanpower', 'Submit', 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
