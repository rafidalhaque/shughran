                    ...
                    <div class="tg-wrap">
                        <table class="tg table table-header-rotated" id="testTable2">
                            ...
                            <tr>
                                ...
                                <?php echo $total_conference['aka_number'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                <?php echo $total_conference['kgp_number'] ?>
                                </td>
                                <td class="tg-0pky">
                                <?php echo $total_conference['kgp_attendence'] ?>
                                </td>
                                <td class="tg-0pky">
                                <?php echo $total_conference['kgp_average'] ?>
                                </td>
                                <td class="tg-0pky">
                                <?php echo $total_conference['kgp_comment'] ?>
                                </td>
