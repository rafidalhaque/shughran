...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-barcode"></i><?= 'ছবি সংগ্রহ' . ' (' . ($branch_id ? $branch->name : 'সকল শাখা') . ')'; ?>
        </h2>
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $shkh_bps = $total_chobi_songroho['shkh_bps'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                   <?php echo $shkh_kpchshho = $total_chobi_songroho['shkh_kpchshho'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                                   <?php echo $shkh_shichs = $total_chobi_songroho['shkh_shichs'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                   <?php echo $thnord_bps = $total_chobi_songroho['thnord_bps'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                   <?php echo $thnord_kpchshho = $total_chobi_songroho['thnord_kpchshho'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                                   <?php echo $thnord_shichs = $total_chobi_songroho['thnord_shichs'] ?>
                                </td>
