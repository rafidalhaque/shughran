...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-barcode"></i><?= 'ভিডিও সংরক্ষণ' . ' (' . ($branch_id ? $branch->name : 'সকল শাখা') . ')'; ?>
        </h2>
...
.table > tbody > tr > td {
	border: 1px solid #ccc;
                   ...
                   <tr>
                       <td class="tg-pwj7" rowspan=""> প্রোগ্রামের ধরন </td>
                   ...
                   <tr>
                       ...
                       <td class="tg-0pky  type_2">
                           <?php echo $gpa5ms_ss = $total_vedio_sonrokkhon['gpa5ms_ss'] ?>
                       </td>
                   ...
                   <tr>
                       ...
                       <td class="tg-0pky  type_2">
                       <?php echo $swf_ss = $total_vedio_sonrokkhon['swf_ss'] ?>
                       </td>
                   ...
                   <tr>
                       ...
                       <td class="tg-0pky  type_2">
                         <?php echo $stssto_ss = $total_vedio_sonrokkhon['stssto_ss'] ?>
                       </td>
                   ...
                   <tr>
                       ...
                       <td class="tg-0pky  type_2">
                         <?php echo $mrs_ss = $total_vedio_sonrokkhon['mrs_ss'] ?>
                       </td>
                   ...
                   <tr>
                       ...
                       <td class="tg-0pky  type_2">
                         <?php echo $tvts_ss = $total_vedio_sonrokkhon['tvts_ss'] ?>
                       </td>
                   ...
                   <tr>
                       ...
                       <td class="tg-0pky  type_2">
                         <?php echo $bdkp_ss = $total_vedio_sonrokkhon['bdkp_ss'] ?>
                       </td>
