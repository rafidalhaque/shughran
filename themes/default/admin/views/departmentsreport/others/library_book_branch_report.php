...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-barcode"></i><?= 'পাঠাগার, বই , শাখা রিপোর্ট' . ' (' . ($branch_id ? $branch->name : 'সকল শাখা') . ')'; ?>
        </h2>
                    ...
                    <div class="tg-wrap">
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $pggt_s = $total_aknojorepathagar_boi_shakha_riport['pggt_s'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $bgt_s = $total_aknojorepathagar_boi_shakha_riport['bgt_s'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $upshgt_s = $total_aknojorepathagar_boi_shakha_riport['upshgt_s'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $satsh_s = $total_aknojorepathagar_boi_shakha_riport['satsh_s'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $snthsh_s = $total_aknojorepathagar_boi_shakha_riport['snthsh_s'] ?>
                                </td>
                                <td class="tg-0pky">
