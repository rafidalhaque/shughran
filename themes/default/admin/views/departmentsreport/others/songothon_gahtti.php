...
<script>
    ...
    $(document).ready(function () {
        oTable = $('#PRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('departmentsreport/getDeficitOrgInstitute'.($branch_id ? '/'.$branch_id : '')) ?>',
            ...
            {column_number: 1, filter_default_label: "[<?='Institution Name';?>]", filter_type: "text", data: []},
            ...
            {column_number: 6, filter_default_label: "[<?='Reason';?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-barcode"></i><?= 'যে সব প্রতিষ্ঠানে সংগঠন ঘাটতি হয়েছে' . ' (' . ($branch_id ? $branch->name : 'সকল শাখা') . ')'; ?>
        </h2>
            ...
            <ul class="btn-tasks">
			 ...
			 <?php if($branch_id) {?>
                <li>
						 ...
						 <a class="tip" title="Add" href="<?=  admin_url('departmentsreport/adddeficitorginstitute/'.$branch_id); ?>" data-toggle='modal' data-target='#myModal'><i class="icon fa fa-plus"> যোগ করুন </i> </a>			 
