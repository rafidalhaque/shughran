...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-barcode"></i><?= 'কুরআন শীক্ষা কার্যক্রম রিপোর্ট' . ' (' . ($branch_id ? $branch->name : 'সকল শাখা') . ')'; ?>
        </h2>
                    ...
                    <div class="tg-wrap">
                        <table class="tg table table-header-rotated" id="testTable2">
                            ...
                            <tr>
                                ...
                                <?php echo $mt_pus = $total_quran_shikkha_karjokrom_riport['mt_pus'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $mt_bms = $total_quran_shikkha_karjokrom_riport['mt_bms'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                                <?php echo $mt_br = $total_quran_shikkha_karjokrom_riport['mt_br'] ?>
                                </td>
                                <td class="tg-0pky  type_4">
                                <?php echo $mt_gt = $total_quran_shikkha_karjokrom_riport['mt_gt'] ?>
                                </td>
                                <td class="tg-0pky  type_5">
                                 <?php echo $shth_oks = $total_quran_shikkha_karjokrom_riport['shth_oks'] ?>
                                </td>
                                <td class="tg-0pky  type_6">
                                 <?php echo $shth_br = $total_quran_shikkha_karjokrom_riport['shth_br'] ?>
                                </td>
