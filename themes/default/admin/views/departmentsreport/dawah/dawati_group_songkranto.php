...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                ...
                class="fa-fw fa fa-barcode"></i><?= 'দাওয়াতি গ্রুপ সংক্রান্ত ' . ' (' . ($branch_id ? $branch->name : 'সকল শাখা') . ')'; ?>
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $gps = $total_vinnodhormabolombider_maje_daoyati_kajer_lokkhon['gps'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                  <?php echo $oks = $total_vinnodhormabolombider_maje_daoyati_kajer_lokkhon['oks'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                                  <?php echo $dps = $total_vinnodhormabolombider_maje_daoyati_kajer_lokkhon['dps'] ?>
                                </td>
                                <td class="tg-0pky  type_4">
                                  <?php echo $gps = $total_vinnodhormabolombider_maje_daoyati_kajer_lokkhon['sbr'] ?>
                                </td>
                                <td class="tg-0pky  type_5">
                                <?php echo $gps = $total_vinnodhormabolombider_maje_daoyati_kajer_lokkhon['bbr'] ?>
                                </td>
                                <td class="tg-0pky  type_5">
                                <?php echo $gps = $total_vinnodhormabolombider_maje_daoyati_kajer_lokkhon['suvkbr'] ?>
                                </td>
