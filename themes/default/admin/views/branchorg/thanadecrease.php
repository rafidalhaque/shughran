...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo 'ঘাটতি' . " (" . $thana->thana_name . ")" ; ?></h4>
        </div>
        
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form','id'=>'decrease_member' , 'autocomplete'=>'off');
        echo admin_form_open_multipart("organization/thanadecrease/" . $thana->id, $attrib); ?>
...
<div class="col-md-12">
        ...
        <div class="modal-footer">
            <?php echo form_submit('thanadecrease', 'Submit', 'class="btn btn-primary thanadecrease"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
