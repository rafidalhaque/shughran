        ...
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i><?= 'আদর্শ থানা ঘাটতি তালিকা: ' .   ' (' . ($branch_id ? $branch->name : 'সকল শাখা') . ')'; ?>
            ...
            if ($report_info['is_current'] || $report_info['year'] == date('Y')) {
                if ($report_info['type'] == 'annual') {
                    echo anchor('admin/organization/decreaselist_ideal_thana' . ($branch_id ? '?branch_id=' . $branch_id : '') . ($branch_id ? '&' : '?') . ('type=half_yearly&year=' . $report_info['year']), 'ষাণ্মাসিক ' . $report_info['year']);
                    ...
                    echo anchor('admin/organization/decreaselist_ideal_thana' . ($branch_id ? '?branch_id=' . $branch_id : ''), 'ষাণ্মাসিক ' . $report_info['year']);
            ...
            <span class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="archive">
                    ...
                    for ($i = date('Y') - 1; $i >= 2019; $i--) {
                        ...
                        echo   ' <li>' . anchor('admin/organization/decreaselist_ideal_thana' .  ($branch_id ? '?branch_id=' . $branch_id : '') . ($branch_id ? '&' : '?') . 'type=half_yearly&year=' . $i, 'ষাণ্মাসিক ' . $i) . ' </li>';
                    }
                    ?>
