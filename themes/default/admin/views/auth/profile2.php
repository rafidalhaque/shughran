    ...
    <div class="col-sm-10">
        ...
        <ul id="myTab" class="nav nav-tabs">
            <li class=""><a href="#edit" class="tab-grey"><?= lang('edit') ?></a></li>
             <li class="hidden"><a href="#cpassword" class="tab-grey"><?= lang('change_password') ?></a></li>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="no">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                echo form_dropdown('branch', $wh, (isset($_POST['branch']) ? $_POST['branch'] : $user->branch_id), 'id="branch" class="form-control select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("branch") . '" style="width:100%;" ');
                                                                                ?>
                                                                            </div>
																			...
																			<div class="form-group">
																				...
																				echo form_dropdown('department', $dept, (isset($_POST['department']) ? $_POST['department'] : $user->department_id), 'id="department" class="form-control select" style="width:100%;" ');
																				?>
																			</div>
