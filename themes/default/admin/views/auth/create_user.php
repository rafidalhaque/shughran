                    ...
                    <div class="col-md-12">
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <?php echo form_input('first_name', '', 'class="form-control" id="first_name" required="required" pattern=".{1,20}"'); ?>
                                </div>
                            </div>
                        ...
                        <div class="col-md-5 col-md-offset-1">
                            ...
                            <div class="no">
                                ...
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('branch', $wh, (isset($_POST['branch']) ? $_POST['branch'] : ''), 'id="branch" class="form-control select" style="width:100%;" ');
                                    ?>
                                </div>
