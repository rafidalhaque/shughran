...
<?php if ($Owner || $GP['bulk_actions']) {
    echo admin_form_open('branch/branch_actions', 'id="action-form"');
} ?>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-barcode"></i><?= lang('branch'); ?>
        </h2>
        ...
        <div class="box-icon">
			...
			<li class="dropdown">
			 <a href="<?= admin_url('branch/add') ?>">
                                <i class="icon fa fa-plus-circle"></i> <?= lang('add_branch') ?>
                            </a>
			 </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="#" class="bpo" title="<b><?= $this->lang->line("delete_branch") ?></b>"
                                data-content="<p><?= lang('r_u_sure') ?></p><button type='button' class='btn btn-danger' id='delete' data-action='delete'><?= lang('i_m_sure') ?></a> <button class='btn bpo-close'><?= lang('no') ?></button>"
                                data-html="true" data-placement="left">
                            <i class="fa fa-trash-o"></i> <?= lang('delete_branch') ?>
                             </a>
                         </li>
                    </ul>
                </li>
