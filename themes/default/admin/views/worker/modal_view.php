...
<?php if (1 || $Owner || $Admin) { ?>
    <div class="buttons">
        <div class="btn-group btn-group-justified">
            ...
            <div class="btn-group">
                <a href="<?= admin_url('worker/edit/' . $manpower->id) ?>" class="tip btn btn-warning tip" title="<?= lang('edit_manpower') ?>">
            ...
            <div class="btn-group">
                <a href="#" class="tip btn btn-danger bpo" title="<b><?= lang("delete_manpower") ?></b>"
                    data-content="<div style='width:150px;'><p><?= lang('r_u_sure') ?></p><a class='btn btn-danger' href='<?= admin_url('worker/delete/' . $manpower->id) ?>'><?= lang('i_m_sure') ?></a> <button class='btn bpo-close'><?= lang('no') ?></button></div>"
